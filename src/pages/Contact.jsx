        ...
        <div className="container">
          <div className="contact__grid">
            ...
            <div className="contact__form-container">
              <h2 id="contact-title" className="contact__title">Send us a Message</h2>
              <form className="contact__form" action="mailto:contact@backplane.com" method="post" enctype="text/plain">
                <div className="form__row">
                  <div className="form__field">
                    <label htmlFor="firstName" className="form__label">First Name <span className="form__required">*</span></label>
                    <input type="text" id="firstName" name="firstName" className="form__input" required aria-describedby="firstName-error" />
                    <div id="firstName-error" className="form__error" role="alert"></div>
                  </div>
                  <div className="form__field">
                    <label htmlFor="lastName" className="form__label">Last Name <span className="form__required">*</span></label>
                    <input type="text" id="lastName" name="lastName" className="form__input" required aria-describedby="lastName-error" />
                    <div id="lastName-error" className="form__error" role="alert"></div>
                  </div>
                </div>

                <div className="form__field">
                  <label htmlFor="email" className="form__label">Email Address <span className="form__required">*</span></label>
                  <input type="email" id="email" name="email" className="form__input" required aria-describedby="email-error" />
                  <div id="email-error" className="form__error" role="alert"></div>
                </div>

                <div className="form__field">
                  <label htmlFor="company" className="form__label">Company Name</label>
                  <input type="text" id="company" name="company" className="form__input" />
                </div>
                ...
                <div className="form__field">
                  <label htmlFor="message" className="form__label">Message <span className="form__required">*</span></label>
                  ...
                  <div id="message-error" className="form__error" role="alert"></div>
                </div>
                ...
                <div className="form__field form__field--checkbox">
                  <label className="form__checkbox-label">
                    <input type="checkbox" id="privacy" name="privacy" className="form__checkbox" required />
                    <span className="form__checkbox-text">I agree to the <Link to="/privacy-policy" className="form__link">Privacy Policy</Link> <span className="form__required">*</span></span>
                  </label>
                  <div id="privacy-error" className="form__error" role="alert"></div>
                </div>
