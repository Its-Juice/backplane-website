  ...
  return (
    <>
          ...
          <div className="hero__content hero__content--clean">
            <header className="hero__header">
              <h1 id="hero-title" className="hero__title hero__title--clean">
                <span className="hero__title-main">Enterprise Infrastructure</span>
            ...
            <footer className="hero__actions hero__actions--clean">
      ...
      <section className="value-props" aria-labelledby="value-title">
        <div className="container">
          <header className="section-header section-header--clean">
            <h2 id="value-title" className="section-title section-title--clean">Why Choose Backplane</h2>
          </header>

          <div className="value-props__grid" role="list">
            <article className="value-prop" role="listitem">
              <div className="value-prop__icon" aria-hidden="true">
                <svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
                  <path d="M24 2L2 14v20l22 12 22-12V14L24 2z" fill="currentColor" opacity="0.8"/>
                  <circle cx="24" cy="24" r="8" fill="currentColor"/>
                </svg>
              </div>
              <header className="value-prop__header">
      ...
      <section className="trust-indicators" aria-labelledby="trust-title">
        <div className="container">
          <header className="trust-indicators__header">
            <h2 id="trust-title" className="sr-only">Trust Indicators</h2>
          </header>
          
          <div className="trust-indicators__grid" role="list">
            <div className="trust-stat" role="listitem">
