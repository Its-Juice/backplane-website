...
function ManagedServicesService() {
  return (
    <>
      {/* Page Header */}
          ...
          <div className="page-header__content">
            <nav aria-label="Breadcrumb" className="breadcrumb">
              <ol className="breadcrumb__list">
                ...
                <li className="breadcrumb__item">
                  <span className="breadcrumb__current" aria-current="page">Managed Services</span>
                </li>
              </ol>
            </nav>
        ...
        <div className="container">
          <div className="service-overview__content">
            <div className="service-overview__text">
              <h2 id="overview-title" className="section-title">Complete IT Management & Support</h2>
      ...
      <section className="cta" aria-labelledby="cta-title">
        <div className="container">
          <div className="cta__content">
            <h2 id="cta-title" className="cta__title">Ready to Focus on Your Business?</h2>
            ...
            <div className="cta__contact-info">
              ...
              <p className="cta__email">managed-services@backplane.com</p>
            </div>
          </div>
        </div>
      </section>
...
export default ManagedServicesService;
